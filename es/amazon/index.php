...
<html lang="es">
   <head>
      ...
      <title>Oferta exclusiva de Amazon para Traders de Latinoamérica</title>
         ...
         <section class="header-section">
            <div class="container">
               <div class="page-content">
                     ...
                     <div class="banner_section_content">
                        <div class="row">
                           ...
                           <div class="col-lg-6 order-lg-2 order-1">
                              <h1 class="head-title text-white"> Oferta exclusiva de Amazon para Traders de Latinoamérica 100% de Bonificación <a class="cursor_point" onclick="openPopup()"> (?) </a> + 20% de Reembolso <a class="cursor_point" onclick="openPopupp()">(?)</a> </h1>
                  ...
                  Compre 100 acciones de Amazon hoy y obtenga una posible ganancia de <b>$4,300</b> antes de fin de año
               </p>
      ...
      <section class="whyChoose-section_main">
         <div class="container-fluid">
            <div class="whyChoose-section text-center mb-5 text-white">
               ...
               <p class="text-white">
                  No pierdas la oportunidad de invertir en la acción más prometedora de Amazo
               </p>
            </div>
            <div class="container">
               <div class="row gy-5">
                  <div class="col-lg-6">
                     <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Crecimiento y rentabilidad a lo largo del tiempo </h4>
                           <p class="text-white">Amazon es una de las herramientas más efectivas para crear riqueza a largo plazo, con el potencial de generar mayores retornos que otras inversiones.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Acceso a los líderes del mercado</h4>
                           <p class="text-white">Invertir en Amazon le permite participar en el éxito de las empresas globales más grandes, desde gigantes tecnológicos hasta empresas de rápido crecimiento.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 mt-4">
                     <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Diversificación y gestión de riesgos. </h4>
                           <p class="text-white">Una cartera de acciones bien equilibrada le ayuda a reducir los riesgos y aprovechar las mejores oportunidades en los diferentes sectores del mercado.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 mt-4">
                     <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Innovación y futuro</h4>
                           <p class="text-white">Desde la inteligencia artificial hasta la transición energética, el mercado de valores es el motor de las innovaciones que darán forma al mundo del mañana.
                           </p>
                        </div>
                     </div>
                  </div>
      ...
      <section class="new_box">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                  <h2 class="py-4">
                     Cómo invertir en Amazon de forma fácil, rápida y segura
                  </h2>
                  <!-- <p class="mb-5">
                  ...
                  <div class="mb-4 d-lg-flex d-block align-items-baseline gap-3">
                     ...
                     <div>
                        ...
                        <p>
                           Deposite sus fondos de forma segura a través de nuestras opciones admitidas.
                        </p>
                     </div>
                  </div>
                  <div class="mb-4 d-lg-flex d-block align-items-baseline gap-3">
                     ...
                     <div>
                        ...
                        <p>¡Todo está listo! Empiece a invertir en Amazon y en más de 3000 activos digitales más
                        </p>
                     </div>
                  </div>
               </div>
...
<div class="popup" id="popupModal">
  <div class="popup-content">
    <p>Bono acreditado en el primer depósito. Si se aplican términos y condiciones.</p>
    <button class="close-btn" onclick="closePopup()">Cerca</button>
  </div>
</div>
...
<div class="popupp" id="popupModall">
  <div class="popup-contentt">
    <p>Reembolso reembolsado a final de mes sobre pérdidas netas</p>
    <button class="close-btnn" onclick="closePopupp()">Cerca</button>
  </div>
</div>
