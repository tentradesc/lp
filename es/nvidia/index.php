...
<html lang="es">
   <head>
      ...
      <title>Oferta exclusiva de Nvidia para Traders de Latinoamérica</title>
      ...
      <script>(function (w, d, s, l, i) {
         ...
         })(window, document, 'script', 'dataLayer', 'GTM-ND9QKSP2');</script>
         ...
         <section class="header-section">
            <div class="container-fluid">
               <div class="page-content">
                     ...
                     <div class="container-fluid banner_section_content">
                        <div class="row">
                           <div class="col-lg-6 text-center">
                              ...
                              <img src="assets/Nvidia.png" alt="Nvidia" class="icon-img d-none d-lg-block">
                           </div>
                           <div class="col-lg-6">
                              <h1 class="head-title text-white"> Oferta exclusiva de Nvidia para Traders de Latinoamérica  100% de Bonificación <a class="cursor_point" onclick="openPopup()"> (?) </a> + 20% de Reembolso <a class="cursor_point" onclick="openPopupp()">(?)</a> </h1>
                              <p class="heroSbHead text-white">Oferta limitada para clientes de Nvidia en América Latina</p>
                              <!-- Form Section -->
                              <section>
                                 ...
                                 <form id="formsubmit" method="POST" class="formLead form-horizontal registration-form">
                                       ...
                                       <div class="row">
                                          <div class="input-group col-lg-12">
                                             ...
                                             <input type="hidden" id="lang" name="lang" class="form-control1" value="<?php $iso_639 ?>" />
                  ...
                  Compre 100 acciones de Nvidia hoy y obtenga una posible ganancia de <b>5,850$</b> antes de fin de año
               </p>
      ...
      <section class="whyChoose-section_main">
         <div class="container-fluid">
            <div class="whyChoose-section text-center mb-5 text-white">
               ...
               <p class="text-white">
                  No pierdas la oportunidad de invertir en las acciones más prometedoras de NVIDIA
               </p>
            </div>
            <div class="container">
               <div class="row gy-5">
                  <div class="col-lg-6">
                     <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Líder en la industria de IA y semiconductores
                           </h4>
                           <p class="text-white">NVIDIA está en el centro de la revolución de la IA y proporciona chips y soluciones avanzadas que se utilizan en centros de datos, automoción, robótica y más.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Dominación en el mundo de los videojuegos</h4>
                           <p class="text-white">Las GPU NVIDIA GeForce son las favoritas de los jugadores y creadores de contenido de todo el mundo e impulsan las florecientes industrias de los videojuegos y los deportes electrónicos.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 mt-4">
                     <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Sólido desempeño financiero
                           </h4>
                           <p class="text-white">
                              Con un crecimiento constante y resultados financieros impresionantes, NVIDIA continúa superando las expectativas y atrayendo la atención de los inversores globales. 
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 mt-4">
                     <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                           <h4 class="text-gold ">Expansión en sectores clave</h4>
                           <p class="text-white">Desde la IA hasta la computación en la nube, desde el metaverso hasta los coches autónomos, NVIDIA está presente en todas las industrias tecnológicas emergentes y ofrece oportunidades de inversión a largo plazo.
      ...
      <section class="new_box">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                  <h2 class="py-4">
                     Cómo invertir en Nvidia de forma fácil, rápida y segura
                  </h2>
                  <!-- <p class="mb-5">
                  ...
                  <div class="mb-4 d-lg-flex d-block align-items-baseline gap-3">
                     ...
                     <div>
                        ...
                        <p>
                           Verifique su identidad verificándola con uno de nuestros socios de confianza.
                        </p>
                     </div>
                  </div>
                  <div class="mb-4 d-lg-flex d-block align-items-baseline gap-3">
               ...
               <div class="col-lg-6 d-flex justify-content-center align-items-center">
                  <img alt="Smartphone displaying investment app interface" class="img-fluid new_img w-100 d-none" src="assets/Image-3.png"/>

                  <img alt="Smartphone displaying investment app interface" class="img-fluid new_img w-100" src="assets/Image-3.png"/>
               </div>
